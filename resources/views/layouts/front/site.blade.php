...
<head>
    ...
    <link rel="icon" type="image/vnd.microsoft.icon"
          href="http://demo.bestprestashoptheme.com/savemart/img/favicon.ico?1531456858">
...
<main id="main-site" class="displayhomenovthree">
    ...
    @include('front.includes.aside-notifications')
            ...
            <div class="w-100">
                <div class="item-language">
                    <a href="http://demo.bestprestashoptheme.com/savemart/en/?home=home_3&SubmitCurrency=1&id_currency=1"
                       class="d-flex align-items-center"><img class="img-fluid mr-2"
                                                              src="http://demo.bestprestashoptheme.com/savemart/img/l/1.jpg"
                ...
                <div class="item-language">
                    <a href="http://demo.bestprestashoptheme.com/savemart/fr/?home=home_3&SubmitCurrency=1&id_currency=1"
                       class="d-flex align-items-center"><img class="img-fluid mr-2"
                                                              src="http://demo.bestprestashoptheme.com/savemart/img/l/2.jpg"
                ...
                <div class="item-language">
                    <a href="http://demo.bestprestashoptheme.com/savemart/es/?home=home_3&SubmitCurrency=1&id_currency=1"
                       class="d-flex align-items-center"><img class="img-fluid mr-2"
                                                              src="http://demo.bestprestashoptheme.com/savemart/img/l/3.jpg"
                ...
                <div class="item-language">
                    <a href="http://demo.bestprestashoptheme.com/savemart/it/?home=home_3&SubmitCurrency=1&id_currency=1"
                       class="d-flex align-items-center"><img class="img-fluid mr-2"
                                                              src="http://demo.bestprestashoptheme.com/savemart/img/l/4.jpg"
                ...
                <div class="item-language">
                    <a href="http://demo.bestprestashoptheme.com/savemart/pl/?home=home_3&SubmitCurrency=1&id_currency=1"
                       class="d-flex align-items-center"><img class="img-fluid mr-2"
                                                              src="http://demo.bestprestashoptheme.com/savemart/img/l/5.jpg"
                ...
                <div class="item-language current">
                    <a href="http://demo.bestprestashoptheme.com/savemart/ar/?home=home_3&SubmitCurrency=1&id_currency=1"
                       class="d-flex align-items-center"><img class="img-fluid mr-2"
                                                              src="http://demo.bestprestashoptheme.com/savemart/img/l/6.jpg"
