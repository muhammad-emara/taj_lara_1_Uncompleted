        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">مرجبا
                  <span
                      class="user-name text-bold-700">  Muhammad Emara</span>
                </span>
...
<footer class="footer footer-static footer-light navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; {{date('Y <a class="text-bold-800 grey darken-2" href="https://www.linkedin.com/in/muhammad-emara/"
                                                                                     target="_blank">Muhammad Emara </a>, All rights reserved. </span>
