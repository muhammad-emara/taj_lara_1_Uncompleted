                        ...
                        <nav id="nov-megamenu" class="clearfix">
                            ...
                            <div id="megamenu" class="nov-megamenu clearfix">
                                <ul class="menu level1"><li class="item home-page has-sub" ><span class="opener"></span><a href="?home" title="Home"><i class="zmdi zmdi-home"></i>Home</a><div class="dropdown-menu" style="width:200px"><ul class=""><li class="item " ><a href="?home=home_1" title="Homepage 1">Homepage 1</a></li>
                                    ...
                                    <li class="item  has-sub" ><span class="opener"></span><a href="#" title="Blog"><i class="zmdi zmdi-library"></i>Blog</a><div class="dropdown-menu" style="width:270px"><ul class=""><li class="item " ><a href="http://demo.bestprestashoptheme.com/savemart/en/index.php?fc=module&amp;module=smartblog&amp;id_post=14&amp;controller=details" title="Blog detail">Blog detail</a></li>
                                    ...
                                    <li class="item menu-page group" ><span class="opener"></span><a href="index.php?controller=sitemap" title="Pages"><i class="zmdi zmdi-assignment"></i>Pages</a><div class="dropdown-menu" ><ul class=""><li class="item container group" ><div class="dropdown-menu" ><ul class=""><li class="item col-md-3 mw-20 html" ><span class="menu-title">Category Style</span><div class="menu-content"><ul class="col">
                                                                        ...
                                                                        <li><a href="http://demo.bestprestashoptheme.com/savemart/index.php?id_product=1&id_product_attribute=1&rewrite=faded-short-sleeves-tshirt&controller=product&id_lang=1&product_detail=product_detail_style_1">Left Column</a></li>
                                                                        <li><a href="http://demo.bestprestashoptheme.com/savemart/index.php?id_product=1&id_product_attribute=1&rewrite=faded-short-sleeves-tshirt&controller=product&id_lang=1&product_detail=product_detail_style_2">Right Column</a></li>
                                                                        <li><a href="http://demo.bestprestashoptheme.com/savemart/index.php?id_product=1&id_product_attribute=1&rewrite=faded-short-sleeves-tshirt&controller=product&id_lang=1&product_detail=product_detail_style_3">Left Thumbnail</a></li>
                                                                        <li><a href="http://demo.bestprestashoptheme.com/savemart/index.php?id_product=1&id_product_attribute=1&rewrite=faded-short-sleeves-tshirt&controller=product&id_lang=1&product_detail=product_detail_style_4">Right Thumbnail</a></li>
                                                                        <li><a href="http://demo.bestprestashoptheme.com/savemart/index.php?id_product=1&id_product_attribute=1&rewrite=faded-short-sleeves-tshirt&controller=product&id_lang=1&product_detail=product_detail_style_5">Outside Thumbnail</a></li>
                                                                        <li><a href="http://demo.bestprestashoptheme.com/savemart/index.php?id_product=1&id_product_attribute=1&rewrite=faded-short-sleeves-tshirt&controller=product&id_lang=1&product_detail=product_detail_style_7">Sticky Image Thumbnail 1</a></li>
                                                                        <li><a href="http://demo.bestprestashoptheme.com/savemart/index.php?id_product=1&id_product_attribute=1&rewrite=faded-short-sleeves-tshirt&controller=product&id_lang=1&product_detail=product_detail_style_6">Sticky Image Thumbnail 2</a></li>
                                                                        <li><a href="http://demo.bestprestashoptheme.com/savemart/index.php?id_product=1&id_product_attribute=2&rewrite=faded-short-sleeves-tshirt&controller=product&id_lang=1&product_detail=product_detail_style_8">Detail Without Sidebar</a></li>
                                                                    </ul></div></li><li class="item col-md-3 mw-20 html" ><span class="menu-title">Bonus Page</span><div class="menu-content"><ul>
                                                                        <li><a href="http://demo.bestprestashoptheme.com/savemart/en/index.php?controller=page-not-found">404 Page</a></li>
                                                                        <li><a href="http://demo.bestprestashoptheme.com/savemart/index.php?controller=contact">Contact Us Page</a></li>
                                                                        <li><a href="http://demo.bestprestashoptheme.com/savemart/index.php?id_cms=4&controller=cms">About Us Page</a></li>
